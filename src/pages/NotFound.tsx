...
const NotFound: React.FC = () => {
 ...
 className="bg-gray-200 text-gray-900 px-6 py-3 rounded-lg font-semibold hoverhover:bg-gray-300 hover:bg-gray-600 transition-colors duration-200 flex items-center justify-center space-x-2"
 >
