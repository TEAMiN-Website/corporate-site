    ...
    <div className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-cooper-hewitt-book font-normal text-gray-900 dark:text-white mb-6">What You'll Gain</h3>
            <div className="space-y-6">
              {t('volunteers.benefits', { returnObjects: true }).map((benefit: any, index: number) => (
                <div key={index} className="flex space-x-4">
                  ...
                  <div>
                    <h4 className="font-cooper-hewitt-book font-normal text-gray-900 dark:text-white mb-2">{benefit.title}</h4>
